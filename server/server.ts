...
app.route('/api/lessons')
    .get(checkIfAuthenticated,
        _.partial(checkIfAuthorized, ['STUDENT']), // pass in only one parameter (roles), other will be populated by express
        readAllLessons);

app.route('/api/admin')
    .post(checkIfAuthenticated,
        _.partial(checkIfAuthorized, ['ADMIN']), // pass in only one parameter (roles), other will be populated by express
        loginAsUser);
